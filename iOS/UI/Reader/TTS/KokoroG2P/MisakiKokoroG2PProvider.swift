...
public final class MisakiKokoroG2PProvider: KokoroG2PProvider {
    ...
    private let fluidAudio: KokoroAneManager

    public init(fluidAudio: KokoroAneManager, british: Bool = false) {
    ...
    public func phonemize(_ text: String) async throws -> KokoroG2PResult {
        ...
        return KokoroG2PResult(phonemes: phonemes, coverage: coverage)
    }
}
